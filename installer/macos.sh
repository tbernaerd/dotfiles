...
# Based on the work by mathiasbynens, edited to fit my needs
...
###############################################################################
# Custom edits by Tom - These were not in the original mathiasbynens set      #                                                              #
###############################################################################

# Set dark theme on Mac OS X
